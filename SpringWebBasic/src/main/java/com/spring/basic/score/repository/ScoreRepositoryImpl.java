...
@Repository // 빈 등록 -> Service가 의존하는 객체니까(Service에서 사용해야되니까)
public class ScoreRepositoryImpl implements IScoreRepository {
	...
	static { //정적 초기화자
		...
		Score stu2 = new Score(new ScoreRequestDTO("춘식이",71,99,87));
	...
	public List<Score> findAll() {
		...
		// SCORE_MAP에서 value들만 전부 뽑아낸 뒤,
		// ArrayList의 생성자의 매개값으로 전달해서 List로 포장
	...
	@Override
	public void modify(Score modScore) { //서비스에서 수정된 객체를 repository로 보냄
