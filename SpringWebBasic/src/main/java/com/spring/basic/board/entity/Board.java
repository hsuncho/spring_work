...
public class Board {
	...
	/*
	 ...
	 - 기존에는 생성자 혹은 setter 메서드를 통해 객체의 필드를 직접 초기화했다면,
	...
	public static class BoardBuilder {
		...
		//2. 내부 클래스의 생성자는 private으로 제한해서
		//Board 클래스 밖에서는호출할 수 없도록 지정
		...
		public BoardBuilder regDate(LocalDateTime regdate, LocalDateTime regDate) {
