...
public class RequestController {
	...
	// '/request/test'라는 요청이 들어오면 이 메서드를 불러줘(미리 세팅해놔야 handler mapping이 검색할 것)
	// return한 문자열은 Dispatcher Servlet에게, View Resolver에게 전달됨
	@RequestMapping("/test")
	...
	/*
	  만약 사용자가 /request/req 요청을 보내왔을 때 view폴더
	  아래에 request 폴더 안에 존재하는 req-ex01.jsp 파일을
	  열도록 메서드를 구성해보세요.
	*/
	@RequestMapping("/req")
	public String req() {
