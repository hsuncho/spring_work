...
public class ResponseController {
	...
	//@RequestParam("age") int age; 파라미터 변수명과 변수명이 동일하니까
	/*
	 1. Model 객체를 사용하여 응답할 화면에 데이터를 전송하기
	 스프링에서 제송하는 Model 타입의 객체를 활용하여 Jsp 파일과 같은 View 템플릿으로
	 데이터를 전송할 수 있습니다.
...
//		model.addAttribute("age", age); //할 필요 없음
	...
	//userPw와 hobby는 null로 초기화되어 값이 넘어오지 않음
	//ModelAttribute 괄호 안의 이름은 EL로 꺼내오기 위해 사용되는 이름
