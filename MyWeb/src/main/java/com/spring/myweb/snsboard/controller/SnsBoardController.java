...
@RestController //모든 메서드에 @ResponseBody를 달게
...
//		System.out.println("fileName: " + fileName);
		...
		//응답에 대한 여러 가지 정보를 전달할 수 있는 객체 ResponseEntity
		...
		try {
			...
			//ResponseEntity 객체에 정달하고자 하는 파일을 byte[]로 변환해서 전달. (파일의 손상을 막기 위해)
			...
			e.printStackTrace();
			//static 메서드를 활용하여 responseEntity 객체 생성 방법
