...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>  
        ...
        <div class="container-fluid">
            ...
            <form action="${pageContext.request.contextPath}/freeboard/freeList">
	    		<div class="search-wrap">
                    ...
                    <!--페이지 네이션을 가져옴-->
		    <form accept="${pageContext.request.contextPath}/freeboard/freeList" name="pageForm">
    ...
    <script>
        ...
        window.onload = function() {
            ...
            //사용자가 페이지 관련 버튼을 클릭했을 떼(이전, 다음, 1, 2, 3...)
            //a 태그의 href에다가 각각 다른 url을 작성해서 요청을 보내기가 귀찮다.
            ...
            document.getElementById('pagination').addEventListener('click', e => {
                ...
                //data- 으로 시작하는 속성값을 dataset property로 쉽게 끌고 올 수 있습니다.
