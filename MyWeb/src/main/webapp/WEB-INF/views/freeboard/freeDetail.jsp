                        ...
                        strAdd += `<div class='reply-wrap'>
                            ...
                            <div class='reply-content'>
                                <div class='reply-group'>
                                    ...
                                    <a href='`+ replyList[i].replyNo +`' class='right replyDelete'><span class='glyphicon glyphicon-pencil'></span>수정</a>
                                    <a href='`+ replyList[i].replyNo +`' class='right replyModify'><span class='glyphicon glyphicon-remove'></span>삭제</a>
                                </div>
