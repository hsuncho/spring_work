...
public class FreeBoardControllerTest {
    ...
    */
	...
	@Autowired //컨테이너에 있는 모든 빈을 사용할 때
...
//	private FreeBoardController controller; -> 이 컨트롤러 하나만 쓸 때
	...
	public void setup() {
		...
		//테스트할 컨트롤러를 수동으로 주입. 하나의 컨트로러 자체만 테스트를 진행할 때는 이렇게 씁니다.
	...
	void testInsert( ) throws Exception {
		String viewName = mockMvc.perform(MockMvcRequestBuilders.post("/freeboard/freeRegister")
	...
	void testContent() throws Exception {
		...
		assertEquals(mv.getViewName(), "freeDetail.jsp");
